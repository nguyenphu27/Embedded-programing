...
#define I2S_TCR2_CLKMODE_MASK                    This_symbol_has_been_deprecated
#define I2S_TCR2_CLKMODE_SHIFT                   This_symbol_has_been_deprecated
#define I2S_TCR2_CLKMODE(x)                      This_symbol_has_been_deprecated
