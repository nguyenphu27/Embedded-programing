...
void EINT1Callback(void) 
{
	...
	print_lcd(3,"                ");
	u32FlashAddress = 0;
	for(u32PageNumber=0; u32PageNumber<1; u32PageNumber++)
	{
...
int main(void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	DrvSPI_Set2BitTransferMode(eDRVSPI_PORT2, 1);				  
